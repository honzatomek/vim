...
syn keyword pythonStatement	class def nextgroup=pythonSpecialDefinition,pythonFunction skipwhite
...
" Jan Tomek
syn match pythonSpecialDefinition "__\w*__" display contained
syn keyword pythonSelfParameter self cls display
...
" Jan Tomek
hi def link pythonFalse                 Statement
hi def link pythonNone                  Statement
hi def link pythonTrue                  Statement
hi def link pythonSpecialDefinition     SpecialKey
hi def link pythonSelfParameter         SpecialKey

" f-strings Jan Tomek
" from: https://phelipetls.github.io/posts/f-strings-syntax-highlighting-in-vim/

if exists("b:permas_res_search")
    finish
endif

nnoremap <buffer> <F5> :call <SID>ResSearch(0)<CR>
nnoremap <buffer> <S-F5> :call <SID>ResSearch(1)<CR>
